# HealthPlatform v0.6.3 — XP & Consistência

> **v0.6.3 — XP & Consistência:** nível, XP, streak e score de consistência agora transformam adesão sustentável em progressão. Treinos são recompensados pela adequação à prontidão, não por intensidade bruta.
