...
if ($health.version -ne "0.13.18") { throw "Versao inesperada da API: $($health.version)" }
...
if ($version.Trim() -ne "0.13.18") { throw "VERSION.txt inesperado." }
...
if (-not $indexSource.Contains("MVP Preview") -or
    -not $indexSource.Contains("v0.13.18") -or
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.6.1 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.6.2 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao atual inconsistente ao validar v0.6.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Compatibilidade v0.6.4 inconsistente na versao atual." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.6.6 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.13.18"')) { throw "Health endpoint nao anuncia v0.6.6." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.7.1 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.13.18"')) { throw "Health endpoint nao anuncia v0.7.1." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.7.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.7.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.8.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.8.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.8.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.8.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.8." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.8.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.5." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.8." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.9.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.10.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.10.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.10.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.10.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.10.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.4." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.12.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.12.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.12.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.12.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.4." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.12.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.5." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.5." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.6." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.6 / Mobile Interaction Experience: OK."


Write-Host "[1145/1152] Validando feedback visual v0.13.18..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
$cssSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.css -Encoding UTF8 -Raw
...
Write-Host "[1151/1152] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_mobile_feedback_experience.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Feedback/UX mobile refinados sem migration nova: OK."

Write-Host "[1152/1152] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Mobile Feedback Experience: OK."

Write-Host "[1153/1160] Validando resumo Em 30 segundos v0.13.18..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
$cssSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.css -Encoding UTF8 -Raw
...
Write-Host "[1158/1160] Validando telas estreitas v0.13.18..."
foreach ($token in @('@media(max-width:390px)','glance-chip{min-height:66px','mobile-home-glance-head small{display:none')) { if (-not $cssSource.Contains($token)) { throw "Ajuste estreito v0.13.18 incompleto: $token" } }
Write-Host "    Resumo permanece legivel em celulares estreitos: OK."

Write-Host "[1159/1160] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_mobile_home_hierarchy.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Hierarquia mobile refinada sem migration nova: OK."

Write-Host "[1160/1160] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
...
Write-Host "[1161/1168] Validando Action Hub mobile v0.13.18..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
$cssSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.css -Encoding UTF8 -Raw
...
Write-Host "[1167/1168] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.11_mobile_action_hub.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Action Hub entregue sem migration nova: OK."

Write-Host "[1168/1168] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Mobile Action Hub: OK."


Write-Host "[1169/1176] Validando resumo pos-treino v0.13.18..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
$cssSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.css -Encoding UTF8 -Raw
...
Write-Host "[1175/1176] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.11_post_workout_mobile_loop.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Loop pos-treino entregue sem migration nova: OK."

Write-Host "[1176/1176] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Post-Workout Mobile Loop: OK."
...
Write-Host "[1183/1184] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.11_recovery_pulse.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Recovery Pulse entregue sem migration nova: OK."

Write-Host "[1184/1184] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Recovery Pulse: OK."
...
Write-Host "[1191/1192] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_daily_athlete_timeline.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Daily Athlete Timeline entregue sem migration nova: OK."

Write-Host "[1192/1192] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Daily Athlete Timeline: OK."
...
Write-Host "[1199/1200] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_weekly_athlete_rhythm.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Weekly Athlete Rhythm entregue sem migration nova: OK."

Write-Host "[1200/1200] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Weekly Athlete Rhythm: OK."
...
Write-Host "[1207/1208] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_training_load_snapshot.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Training Load Snapshot entregue sem migration nova: OK."

Write-Host "[1208/1208] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Training Load Snapshot: OK."
...
Write-Host "[1215/1216] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_mobile_insight_rail.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Mobile Insight Rail entregue sem migration nova: OK."

Write-Host "[1216/1216] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Mobile Insight Rail: OK."
...
Write-Host "[1223/1224] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_body_context_brief.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Body Context Brief entregue sem migration nova: OK."

Write-Host "[1224/1224] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Body Context Brief: OK."
...
Write-Host "[1231/1232] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_consistency_compass.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Consistency Compass entregue sem migration nova: OK."

Write-Host "[1232/1232] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Consistency Compass: OK."
...
Write-Host "[1239/1240] Validando schema preservado na v0.13.18..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[38/38] Aplicando upgrade v0.10.3') -or (Test-Path .\scripts\sql\v0.13.18_daily_closure.sql)) { throw "v0.13.18 nao deveria alterar schema 38/38." }
Write-Host "    Daily Closure entregue sem migration nova: OK."

Write-Host "[1240/1240] Validando versao funcional v0.13.18..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.13.18" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.13.18';")) { throw "Versao v0.13.18 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.13.18"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.18." }
if (-not $indexSource.Contains('MVP Preview') -or -not $indexSource.Contains('v0.13.18')) { throw "MVP Preview nao anuncia v0.13.18." }
Write-Host "    v0.13.18 / Daily Closure: OK."
