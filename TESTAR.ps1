...
if ($health.version -ne "0.19.6") { throw "Versao inesperada da API: $($health.version)" }
...
if ($version.Trim() -ne "0.19.6") { throw "VERSION.txt inesperado." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.6.1 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.6.2 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao atual inconsistente ao validar v0.6.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Compatibilidade v0.6.4 inconsistente na versao atual." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.6.6 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.19.6"')) { throw "Health endpoint nao anuncia v0.6.6." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.7.1 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.19.6"')) { throw "Health endpoint nao anuncia v0.7.1." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.7.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.7.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.8.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.8.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.8.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.8.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.8." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.8.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.5." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.8." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.9.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.10.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.10.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.10.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.10.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.10.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.4." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.12.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.12.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.12.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.12.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.4." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.12.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.5." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.13.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.13.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.13.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.5." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.13.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.6." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_UI_FOUNDATION='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_NAVIGATION_SHELL='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_CONTENT_HIERARCHY='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_DATA_VIEWS='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_FORMS_INPUTS='v0.14.4'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_FEEDBACK_STATES='v0.14.5'")) { throw "Compatibilidade v0.14.5 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.14.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_CHARTS_PROGRESS='v0.14.6'")) { throw "Versao v0.14.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.6." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_MODALS_SHEETS='v0.14.7'")) { throw "Compatibilidade v0.14.7 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.14.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_ATHLETE_PROFILE_MOBILE='v0.14.8'")) { throw "Compatibilidade v0.14.8 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.14.8." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MOBILE_ACCESSIBILITY_POLISH='v0.14.9'")) { throw "Versao v0.14.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.9." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_ATHLETE_HOME_2='v0.15.0'")) { throw "Versao v0.15.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.15.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_MORNING_CHECKIN='v0.15.1'")) { throw "Compatibilidade Morning Check-in inconsistente na versao atual." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_TRAINING_DAY_FLOW='v0.15.2'")) { throw "Compatibilidade Training Day Flow inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_RECOVERY_DAY_FLOW='v0.15.3'")) { throw "Compatibilidade Recovery Day Flow inconsistente na versao atual." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_END_OF_DAY_FLOW='v0.15.4'")) { throw "Versao v0.15.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.15.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_WEEKLY_REVIEW='v0.15.5'")) { throw "Versao v0.15.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.15.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_ATHLETE_PROGRESS_STORY='v0.15.6'")) { throw "Versao v0.16.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.0." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_ATHLETE_LEVEL_SYSTEM='v0.16.0'")) { throw "Versao corrente v0.16.1 inconsistente no baseline do Level System." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_STREAK_INTELLIGENCE='v0.16.1'")) { throw "Versao v0.16.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_DYNAMIC_MISSIONS='v0.16.2'")) { throw "Versao v0.16.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.2." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_ACHIEVEMENT_FAMILIES='v0.16.3'")) { throw "Versao v0.16.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_WEEKLY_CHALLENGES='v0.16.4'")) { throw "Versao v0.16.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_SEASONAL_PROGRESS='v0.16.5'")) { throw "Versao v0.16.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_PROFESSIONAL_PRESCRIPTION_WORKSPACE='v0.17.0'")) { throw "Versao v0.17.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_PATIENT_INTAKE_BODY_ASSESSMENT='v0.17.1'")) { throw "Versao v0.17.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_TREATMENT_GOAL_INITIAL_RECOMMENDATION='v0.17.2'")) { throw "Versao v0.17.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_RECOMMENDATION_TUNING_WORKSPACE='v0.17.3'")) { throw "Versao v0.17.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_WORKOUT_BUILDER_2='v0.17.4'")) { throw "Versao v0.17.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_WORKOUT_LIBRARY_ASSIGNMENT='v0.17.5'")) { throw "Versao v0.17.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_NUTRITION_BUILDER_2='v0.17.6'")) { throw "Versao v0.17.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_DIET_MEAL_LIBRARY='v0.17.7'")) { throw "Versao v0.17.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $appJsSource.Contains("HP_PATIENT_PREFERENCES_SMART_ADAPTATION='v0.17.8'")) { throw "Compatibilidade v0.17.8 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.17.8." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao corrente inconsistente ao validar v0.17.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Compatibilidade da AESYN Foundation inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.18.0." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.2." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.6." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.8." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.9." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.10 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.10." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao funcional v0.18.11 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.11." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao publica v0.18.14 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.14." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
foreach ($token in @('NUTRITION BUILDER • LARGE CATALOG UX • v0.18.13','Estrutura rápida:','Busca inteligente por nome e categoria','TOTAL ESTIMADO DO PLANO')) { if (-not $appJsSource.Contains($token)) { throw "Entrega funcional v0.18.13 incompleta: $token" } }
...
foreach ($token in @("HP_NUTRITION_TEMPLATES_2='v0.18.14'",'NUTRITION TEMPLATES 2.0 • v0.18.14','hpOpenNutritionTemplates2','openDietMealLibrary=hpOpenNutritionTemplates2')) { if (-not $appJsSource.Contains($token)) { throw "Nutrition Templates 2.0 incompleto: $token" } }
...
foreach ($token in @("HP_NUTRITION_REVIEW_PUBLISH_2='v0.18.15'",'NUTRITION REVIEW & PUBLISH 2.0 • v0.18.15','hpOpenNutritionReviewPublish2','Revisar & publicar alimentação')) { if (-not $appJsSource.Contains($token)) { throw "Nutrition Review & Publish 2.0 incompleto: $token" } }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao publica v0.18.15 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.15." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
Write-Host "    Schema 39/39 + Health + VERSION + interface de producao: OK."
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao publica v0.19.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
Write-Host "    Schema 39/39 + Health + VERSION + interface de producao: OK."
...
foreach ($token in @("HP_MVP_VERSION='0.19.6'",'HP_THEME_KEY','hpInstallThemeUi','loadPatientHealth','patient-health-hub-v0190')) { if (-not ($appJsSource.Contains($token) -or $cssSource.Contains($token))) { throw "Foundation v0.19.1 incompleta: $token" } }
...
$version = Get-Content .\VERSION.txt -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.6' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.6';")) { throw "Versao publica v0.19.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.5." }
...
if ($version0193.Trim() -ne "0.19.6") { throw "VERSION.txt inesperado para a versao atual." }
...
if (-not $healthSource0193.Contains('version = "0.19.6"')) { throw "Health endpoint nao anuncia a versao atual." }
...
if ($version0194.Trim() -ne '0.19.6' -or -not $appJs0194.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $health0194.Contains('version = "0.19.6"')) { throw "Versao publica v0.19.5 inconsistente." }
...
if ($version0195.Trim() -ne '0.19.6' -or -not $appJs0195.Contains("const HP_MVP_VERSION='0.19.6';") -or -not $health0195.Contains('version = "0.19.6"')) { throw "Versao publica v0.19.5 inconsistente." }
...
if ($version0196.Trim() -ne '0.19.6' -or -not $appJs0196.Contains("const HP_MVP_VERSION='0.19.6';") -or (($health0196 | Select-String -Pattern 'version = "0.19.6"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica v0.19.6 inconsistente." }
