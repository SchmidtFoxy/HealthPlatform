...
if ($health.version -ne "0.7.1") { throw "Versao inesperada da API: $($health.version)" }
...
if ($version.Trim() -ne "0.7.1") { throw "VERSION.txt inesperado." }
...
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if (-not $indexSource.Contains("MVP Preview • v0.7.1") -or
...
Write-Host "[600/688] Validando compatibilidade funcional v0.6.0..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1") { throw "VERSION.txt inesperado." }
...
Write-Host "[601/688] Validando entidade de prontidao diaria..."
...
Write-Host "[602/688] Validando mapeamento EF da prontidao..."
$dbContextSource = Get-Content .\src\HealthPlatform.Infrastructure\Data\AppDbContext.cs -Encoding UTF8 -Raw
...
Write-Host "[603/688] Validando endpoint PatientOnly de prontidao..."
...
Write-Host "[604/688] Validando travas de seguranca do score..."
...
Write-Host "[605/688] Validando Home Daily Athlete..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[606/688] Validando leitura profissional da prontidao..."
...
Write-Host "[607/688] Validando SQL e migration v0.6.1..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
...
Write-Host "[608/688] Validando versao funcional v0.6.1..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.6.1 inconsistente." }
Write-Host "    v0.6.1 / Daily Athlete + Prontidao Diaria: OK."



Write-Host "[609/688] Validando ledger de XP..."
...
Write-Host "[610/688] Validando mapeamento EF de XP..."
$dbContextSource = Get-Content .\src\HealthPlatform.Infrastructure\Data\AppDbContext.cs -Encoding UTF8 -Raw
...
Write-Host "[611/688] Validando XP seguro de treino..."
...
Write-Host "[612/688] Validando nivel, streak e consistencia..."
...
Write-Host "[613/688] Validando eventos de autocuidado..."
$portalMeSource = Get-Content .\src\HealthPlatform.Api\Controllers\MeuPortalPacienteController.cs -Encoding UTF8 -Raw
...
Write-Host "[614/688] Validando Home esportiva gamificada..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[615/688] Validando SQL e migration v0.6.2..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
...
Write-Host "[616/688] Validando versao funcional v0.6.2..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.6.2 inconsistente." }
Write-Host "    v0.6.2 / XP + Nivel + Streak + Consistencia: OK."

Write-Host "[617/688] Validando entidades de desafios e conquistas..."
...
Write-Host "[618/688] Validando mapeamento EF de missoes..."
$dbContextSource = Get-Content .\src\HealthPlatform.Infrastructure\Data\AppDbContext.cs -Encoding UTF8 -Raw
...
Write-Host "[619/688] Validando mapeamento EF de conquistas..."
...
Write-Host "[620/688] Validando missoes automaticas..."
$gameSource = Get-Content .\src\HealthPlatform.Api\Services\GamificacaoService.cs -Encoding UTF8 -Raw
...
Write-Host "[621/688] Validando conquistas esportivas..."
...
Write-Host "[622/688] Validando Home com missoes e conquistas..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[623/688] Validando SQL e migration v0.6.3..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
...
Write-Host "[624/688] Validando compatibilidade funcional v0.6.3..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao atual inconsistente ao validar v0.6.3." }
Write-Host "    v0.6.3 / Missoes + Desafios + Conquistas preservada: OK."


Write-Host "[625/688] Validando entidade de ciclo esportivo..."
...
Write-Host "[626/688] Validando mapeamento EF de ciclos..."
$dbContextSource = Get-Content .\src\HealthPlatform.Infrastructure\Data\AppDbContext.cs -Encoding UTF8 -Raw
...
Write-Host "[627/688] Validando gestao profissional de ciclos..."
...
Write-Host "[628/688] Validando resumo longitudinal do ciclo..."
...
Write-Host "[629/688] Validando desafio semanal adaptado ao ciclo..."
$gameSource = Get-Content .\src\HealthPlatform.Api\Services\GamificacaoService.cs -Encoding UTF8 -Raw
...
Write-Host "[630/688] Validando Home e leitura profissional do ciclo..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[631/688] Validando SQL e migration v0.6.4..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
...
Write-Host "[632/688] Validando compatibilidade funcional v0.6.4..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Compatibilidade v0.6.4 inconsistente na versao atual." }
Write-Host "    v0.6.4 / Ciclos Esportivos + Metas de Ciclo preservado: OK."

Write-Host "[633/688] Validando contrato da Estrategia do Dia..."
...
Write-Host "[634/688] Validando motor de adaptacao esportiva..."
...
Write-Host "[635/688] Validando trava contra sobrecarga automatica..."
...
Write-Host "[636/688] Validando integracao com ciclo e planos prescritos..."
...
Write-Host "[637/688] Validando Home Daily Athlete com Estrategia do Dia..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[638/688] Validando leitura profissional da estrategia diaria..."
...
Write-Host "[639/688] Validando ausencia de alteracao indevida de schema..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
...
Write-Host "[640/688] Validando compatibilidade funcional v0.6.5..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.6.6 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.7.1"')) { throw "Health endpoint nao anuncia v0.6.6." }
Write-Host "    v0.6.5 / Estrategia do Dia preservada: OK."



Write-Host "[641/688] Validando contrato de execucao guiada..."
$portalContracts = Get-Content .\src\HealthPlatform.Api\Contracts\Portal\PortalPacienteContracts.cs -Encoding UTF8 -Raw
...
Write-Host "[642/688] Validando motor do Roteiro de Hoje..."
...
Write-Host "[643/688] Validando progresso baseado em registros reais..."
...
Write-Host "[644/688] Validando fechamento diario idempotente..."
$portalMeSource = Get-Content .\src\HealthPlatform.Api\Controllers\MeuPortalPacienteController.cs -Encoding UTF8 -Raw
...
Write-Host "[645/688] Validando Home com Roteiro de Hoje..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[646/688] Validando leitura profissional da execucao..."
...
Write-Host "[647/688] Validando ausencia de alteracao indevida de schema v0.6.6..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
...
Write-Host "[648/688] Validando compatibilidade funcional v0.6.6..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.6.6 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.7.1"')) { throw "Health endpoint nao anuncia v0.6.6." }
...
Write-Host "[649/688] Validando contrato de tendencias de recuperacao..."
$portalContracts = Get-Content .\src\HealthPlatform.Api\Contracts\Portal\PortalPacienteContracts.cs -Encoding UTF8 -Raw
...
Write-Host "[650/688] Validando janela longitudinal 7 vs 7 dias..."
...
Write-Host "[651/688] Validando sinais esportivos observaveis..."
...
Write-Host "[652/688] Validando alertas conservadores de recuperacao..."
...
Write-Host "[653/688] Validando ausencia de diagnostico automatico..."
...
Write-Host "[654/688] Validando Home e prontuario com tendencia de recuperacao..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[655/688] Validando ausencia de alteracao indevida de schema v0.6.7..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "PREPARAR 37/37 foi alterado sem necessidade." }
...
Write-Host "[656/688] Validando compatibilidade funcional v0.6.7..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.7.1 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.7.1"')) { throw "Health endpoint nao anuncia v0.7.1." }
Write-Host "    v0.6.7 / Tendencias de Recuperacao + Alertas Inteligentes preservada: OK."


Write-Host "[657/688] Validando contrato de performance esportiva..."
$portalContracts = Get-Content .\src\HealthPlatform.Api\Contracts\Portal\PortalPacienteContracts.cs -Encoding UTF8 -Raw
...
Write-Host "[658/688] Validando motor de performance a partir das execucoes reais..."
...
Write-Host "[659/688] Validando deteccao conservadora de PR..."
...
Write-Host "[660/688] Validando contexto de prontidao no PR..."
...
Write-Host "[661/688] Validando linguagem segura de performance..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[662/688] Validando Home e prontuario com Performance & PRs..."
...
Write-Host "[663/688] Validando ausencia de alteracao indevida de schema v0.6.8..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "PREPARAR 37/37 foi alterado sem necessidade." }
...
Write-Host "[664/688] Validando compatibilidade funcional v0.6.8..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.1"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
Write-Host "    v0.6.8 / Performance & PRs preservada: OK."

Write-Host "[665/688] Validando contrato de carga de treino..."
$portalContracts = Get-Content .\src\HealthPlatform.Api\Contracts\Portal\PortalPacienteContracts.cs -Encoding UTF8 -Raw
...
Write-Host "[666/688] Validando motor sRPE sobre execucoes reais..."
...
Write-Host "[667/688] Validando linha de base de tres semanas..."
...
Write-Host "[668/688] Validando integracao com recuperacao..."
...
Write-Host "[669/688] Validando linguagem conservadora da carga..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[670/688] Validando Home e prontuario com carga semanal..."
...
Write-Host "[671/688] Validando ausencia de alteracao indevida de schema v0.7.1..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "PREPARAR 37/37 foi alterado sem necessidade." }
...
Write-Host "[672/688] Validando compatibilidade funcional v0.6.9..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.1"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
Write-Host "[673/688] Validando contrato do Coach Diario..."
$portalContracts = Get-Content .\src\HealthPlatform.Api\Contracts\Portal\PortalPacienteContracts.cs -Encoding UTF8 -Raw
...
Write-Host "[674/688] Validando motor de sintese contextual..."
...
Write-Host "[675/688] Validando prioridades de seguranca do Coach..."
...
Write-Host "[676/688] Validando ausencia de prescricao automatica..."
...
Write-Host "[677/688] Validando integracao do Coach nas duas Homes..."
...
Write-Host "[678/688] Validando UI do Coach Diario..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
...
Write-Host "[679/688] Validando ausencia de alteracao indevida de schema v0.7.1..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "PREPARAR 37/37 foi alterado sem necessidade." }
...
Write-Host "[680/688] Validando compatibilidade funcional v0.7.0..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.1"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
Write-Host "[681/688] Validando versao v0.7.1..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.1" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.1';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.1"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
Write-Host "[682/688] Validando seed Ana sem variavel automatica PID..."
$anaSeedSource = Get-Content .\POPULAR-ANA-RIBEIRO.ps1 -Encoding UTF8 -Raw
...
Write-Host "[683/688] Validando healthcheck preventivo do seed Ana..."
...
Write-Host "[684/688] Validando mensagem de login administrativo do seed..."
...
Write-Host "[685/688] Validando URL local padrao do seed..."
...
Write-Host "[686/688] Validando janela esportiva rica da Ana..."
...
Write-Host "[687/688] Validando Coach Diario preservado na v0.7.1..."
$coachSource = Get-Content .\src\HealthPlatform.Api\Services\CoachDiarioService.cs -Encoding UTF8 -Raw
...
Write-Host "[688/688] Validando versao funcional v0.7.1..."
