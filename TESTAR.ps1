...
if ($health.version -ne "0.19.30") { throw "Versao inesperada da API: $($health.version)" }
...
if ($version.Trim() -ne "0.19.30") { throw "VERSION.txt inesperado." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.6.1 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.6.2 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao atual inconsistente ao validar v0.6.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Compatibilidade v0.6.4 inconsistente na versao atual." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.6.6 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.19.30"')) { throw "Health endpoint nao anuncia v0.6.6." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.7.1 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.19.30"')) { throw "Health endpoint nao anuncia v0.7.1." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao corrente inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.26." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.7.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.7.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.8.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.8.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.8.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.8.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.8." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.8.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.8.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.5." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.7." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.8." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.9.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.9.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.10.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.10.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.10.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.10.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.10.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.10.4." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.12.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.12.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.1." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.12.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.2." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.12.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.4." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.12.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.12.5." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.13.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.0." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.13.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.13.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.5." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.13.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.13.6." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
Write-Host "[1161/1168] Validando central Hoje em um olhar v0.19.30..."
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
$cssSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.css -Encoding UTF8 -Raw
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_UI_FOUNDATION='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_NAVIGATION_SHELL='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_CONTENT_HIERARCHY='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_DATA_VIEWS='v0.14.3'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_FORMS_INPUTS='v0.14.4'")) { throw "Versao v0.14.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_FEEDBACK_STATES='v0.14.5'")) { throw "Compatibilidade v0.14.5 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.14.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_CHARTS_PROGRESS='v0.14.6'")) { throw "Versao v0.14.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.6." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_MODALS_SHEETS='v0.14.7'")) { throw "Compatibilidade v0.14.7 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.14.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_ATHLETE_PROFILE_MOBILE='v0.14.8'")) { throw "Compatibilidade v0.14.8 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.14.8." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MOBILE_ACCESSIBILITY_POLISH='v0.14.9'")) { throw "Versao v0.14.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.14.9." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_ATHLETE_HOME_2='v0.15.0'")) { throw "Versao v0.15.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.15.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_MORNING_CHECKIN='v0.15.1'")) { throw "Compatibilidade Morning Check-in inconsistente na versao atual." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_TRAINING_DAY_FLOW='v0.15.2'")) { throw "Compatibilidade Training Day Flow inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_RECOVERY_DAY_FLOW='v0.15.3'")) { throw "Compatibilidade Recovery Day Flow inconsistente na versao atual." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_END_OF_DAY_FLOW='v0.15.4'")) { throw "Versao v0.15.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.15.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_WEEKLY_REVIEW='v0.15.5'")) { throw "Versao v0.15.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.15.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_ATHLETE_PROGRESS_STORY='v0.15.6'")) { throw "Versao v0.16.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.0." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_ATHLETE_LEVEL_SYSTEM='v0.16.0'")) { throw "Versao corrente v0.16.1 inconsistente no baseline do Level System." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_STREAK_INTELLIGENCE='v0.16.1'")) { throw "Versao v0.16.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_DYNAMIC_MISSIONS='v0.16.2'")) { throw "Versao v0.16.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.2." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_ACHIEVEMENT_FAMILIES='v0.16.3'")) { throw "Versao v0.16.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_WEEKLY_CHALLENGES='v0.16.4'")) { throw "Versao v0.16.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_SEASONAL_PROGRESS='v0.16.5'")) { throw "Versao v0.16.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.16.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_PROFESSIONAL_PRESCRIPTION_WORKSPACE='v0.17.0'")) { throw "Versao v0.17.0 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_PATIENT_INTAKE_BODY_ASSESSMENT='v0.17.1'")) { throw "Versao v0.17.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_TREATMENT_GOAL_INITIAL_RECOMMENDATION='v0.17.2'")) { throw "Versao v0.17.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_RECOMMENDATION_TUNING_WORKSPACE='v0.17.3'")) { throw "Versao v0.17.3 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.3." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_WORKOUT_BUILDER_2='v0.17.4'")) { throw "Versao v0.17.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_WORKOUT_LIBRARY_ASSIGNMENT='v0.17.5'")) { throw "Versao v0.17.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_NUTRITION_BUILDER_2='v0.17.6'")) { throw "Versao v0.17.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_DIET_MEAL_LIBRARY='v0.17.7'")) { throw "Versao v0.17.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.17.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $appJsSource.Contains("HP_PATIENT_PREFERENCES_SMART_ADAPTATION='v0.17.8'")) { throw "Compatibilidade v0.17.8 inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.17.8." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
if ($version.Trim() -ne "0.19.30" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao corrente inconsistente ao validar v0.17.9." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Compatibilidade da AESYN Foundation inconsistente na versao atual." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam a versao atual ao validar v0.18.0." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.2 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.2." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.4 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.4." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.5." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$version = Get-Content .\VERSION.txt -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.6." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.7 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.7." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.8 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.8." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.9 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.9." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.10 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.10." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao funcional v0.18.11 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.11." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao publica v0.18.14 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.14." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao publica v0.18.15 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.18.15." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
Write-Host "    Schema 39/39 + Health + VERSION + interface de producao: OK."
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao publica v0.19.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.1." }
if (-not $indexSource.Contains('AESYN') -or $indexSource.Contains('MVP Preview')) { throw "Interface publica de producao inconsistente." }
Write-Host "    Schema 39/39 + Health + VERSION + interface de producao: OK."
...
foreach ($token in @("HP_MVP_VERSION='0.19.30'",'HP_THEME_KEY','hpInstallThemeUi','loadPatientHealth','patient-health-hub-v0190')) { if (-not ($appJsSource.Contains($token) -or $cssSource.Contains($token))) { throw "Foundation v0.19.1 incompleta: $token" } }
...
$version = Get-Content .\VERSION.txt -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne '0.19.30' -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Versao publica v0.19.5 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.5." }
...
if ($version0193.Trim() -ne "0.19.30") { throw "VERSION.txt inesperado para a versao atual." }
...
if (-not $healthSource0193.Contains('version = "0.19.30"')) { throw "Health endpoint nao anuncia a versao atual." }
...
if ($version0194.Trim() -ne '0.19.30' -or -not $appJs0194.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $health0194.Contains('version = "0.19.30"')) { throw "Versao publica v0.19.5 inconsistente." }
...
if ($version0195.Trim() -ne '0.19.30' -or -not $appJs0195.Contains("const HP_MVP_VERSION='0.19.30';") -or -not $health0195.Contains('version = "0.19.30"')) { throw "Versao publica v0.19.5 inconsistente." }
...
if ($version0196.Trim() -ne '0.19.30' -or -not $appJs0196.Contains("const HP_MVP_VERSION='0.19.30';") -or (($health0196 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica v0.19.6 inconsistente." }
...
if ($version0197.Trim() -ne '0.19.30' -or -not $appJs0197.Contains("const HP_MVP_VERSION='0.19.30';") -or (($health0197 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica atual inconsistente." }
...
if ($version0198.Trim() -ne '0.19.30' -or -not $appJs0198.Contains("const HP_MVP_VERSION='0.19.30';") -or (($health0198 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica atual inconsistente." }
...
if ($version0199.Trim() -ne '0.19.30' -or -not $appJs0199.Contains("const HP_MVP_VERSION='0.19.30';") -or (($health0199 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica v0.19.9 inconsistente." }
...
if ($version01910.Trim() -ne '0.19.30' -or -not $appJs01910.Contains("const HP_MVP_VERSION='0.19.30';") -or (($health01910 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica v0.19.10 inconsistente." }
...
if ($version01911.Trim() -ne '0.19.30' -or -not $appJs01911.Contains("const HP_MVP_VERSION='0.19.30';") -or (($health01911 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2)) { throw "Versao publica v0.19.11 inconsistente." }
...
if ($version01912 -ne "0.19.30") { throw "VERSION.txt inesperado na v0.19.12." }
$health01912 = Get-Content (Join-Path $root "src/HealthPlatform.Api/Controllers/HealthController.cs") -Raw -Encoding UTF8
if (($health01912 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.12." }
if (-not $appJs01912.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Interface nao anuncia v0.19.12 internamente." }
...
if ($version01913 -ne "0.19.30") { throw "VERSION.txt inesperado na v0.19.13." }
$health01913 = Get-Content (Join-Path $root "src/HealthPlatform.Api/Controllers/HealthController.cs") -Raw -Encoding UTF8
if (($health01913 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.13." }
if (-not $appJs01913.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Interface nao anuncia v0.19.13 internamente." }
...
if ($version01914 -ne "0.19.30") { throw "VERSION.txt inesperado na v0.19.14." }
if (($health01914 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.14." }
if (-not $appJs01914.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Interface nao anuncia v0.19.14 internamente." }
...
if (-not $indexSource.Contains('/app.css?v=0.19.30') -or -not $indexSource.Contains('/app.js?v=0.19.30')) { throw 'Cache busting dos assets ausente.' }
...
if ($version.Trim() -ne "0.19.30") { throw "VERSION.txt inesperado para v0.19.15." }
if (-not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "Interface nao anuncia v0.19.15." }
...
if ($version01916 -ne '0.19.30') { throw 'VERSION.txt inesperado ao validar v0.19.16.' }
if (($health01916 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health atual inconsistente ao validar v0.19.16.' }
if (-not $appJs01916.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface atual inconsistente ao validar v0.19.16.' }
if (-not $index01916.Contains('/app.css?v=0.19.30') -or -not $index01916.Contains('/app.js?v=0.19.30')) { throw 'Cache busting atual ausente ao validar v0.19.16.' }
...
if ($version01917 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.17.' }
if (($health01917 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.17.' }
if (-not $appJs01917.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.17.' }
if (-not $index01917.Contains('/app.css?v=0.19.30') -or -not $index01917.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.17 ausente.' }
...
if ($version01918 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.18.' }
if (($health01918 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.18.' }
if (-not $appJs01918.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.18.' }
if (-not $index01918.Contains('/app.css?v=0.19.30') -or -not $index01918.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.18 ausente.' }
...
if ($version01919 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.19.' }
if (($health01919 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.19.' }
if (-not $appJs01919.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.19.' }
if (-not $index01919.Contains('/app.css?v=0.19.30') -or -not $index01919.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.19 ausente.' }
...
if ($version01920 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.20.' }
if (($health01920 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.20.' }
if (-not $appJs01920.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.20.' }
if (-not $index01920.Contains('/app.css?v=0.19.30') -or -not $index01920.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.20 ausente.' }
...
if ($version01921 -ne '0.19.30') { throw 'VERSION.txt inesperado ao validar v0.19.21.' }
if (($health01921 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health atual inconsistente ao validar v0.19.21.' }
if (-not $appJs01921.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface atual inconsistente ao validar v0.19.21.' }
if (-not $index01921.Contains('/app.css?v=0.19.30') -or -not $index01921.Contains('/app.js?v=0.19.30')) { throw 'Cache busting atual ausente ao validar v0.19.21.' }
...
if ($version.Trim() -ne "0.19.30") { throw "VERSION.txt nao anuncia v0.19.22." }
if (-not $appJsSource.Contains("const HP_MVP_VERSION='0.19.30';")) { throw "HP_MVP_VERSION nao anuncia v0.19.22." }
if (($healthSource | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.19.22." }
...
if ($version01923 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.23.' }
if (($health01923 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.23.' }
if (-not $appJs01923.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.23.' }
if (-not $index01923.Contains('/app.css?v=0.19.30') -or -not $index01923.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.23 ausente.' }
...
if ($version01924 -ne '0.19.30') { throw 'VERSION.txt corrente inesperado ao validar compatibilidade da v0.19.24.' }
if (($health01924 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia a versao publica corrente.' }
if (-not $appJs01924.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia a versao publica corrente.' }
if (-not $index01924.Contains('/app.css?v=0.19.30') -or -not $index01924.Contains('/app.js?v=0.19.30')) { throw 'Cache busting da versao publica corrente ausente.' }
...
if ($version01925 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.26.' }
if (($health01925 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.26.' }
if (-not $appJs01925.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.26.' }
if (-not $index01925.Contains('/app.css?v=0.19.30') -or -not $index01925.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.26 ausente.' }
...
if ($version01926 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.26.' }
if (($health01926 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.26.' }
if (-not $program01926.Contains('Version = "v0.19.30"')) { throw 'Swagger nao anuncia v0.19.26.' }
if (-not $appJs01926.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.26.' }
if (-not $index01926.Contains('/app.css?v=0.19.30') -or -not $index01926.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.26 ausente.' }
Write-Host "    API/UI/VERSION: 0.19.26 OK." -ForegroundColor Green
...
if ($version01927 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.27.' }
if (($health01927 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.27.' }
if (-not $program01927.Contains('Version = "v0.19.30"')) { throw 'Swagger nao anuncia v0.19.27.' }
if (-not $appJs01927.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.27.' }
if (-not $index01927.Contains('/app.css?v=0.19.30') -or -not $index01927.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.27 ausente.' }
...
if ($version01928 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.28.' }
if (($health01928 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.28.' }
if (-not $program01928.Contains('Version = "v0.19.30"')) { throw 'Swagger nao anuncia v0.19.28.' }
if (-not $appJs01928.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.28.' }
if (-not $index01928.Contains('/app.css?v=0.19.30') -or -not $index01928.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.28 ausente.' }
...
foreach ($token in @('/manifest.webmanifest?v=0.19.30','/icons/favicon-32.png?v=0.19.30','/icons/apple-touch-icon.png?v=0.19.30','apple-mobile-web-app-capable','AESYN Performance')) { if (-not $index01929.Contains($token)) { throw "Identidade HTML incompleta: $token" } }
...
if ($version01929 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.29.' }
if (($health01929 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.29.' }
if (-not $program01929.Contains('Version = "v0.19.30"')) { throw 'Swagger nao anuncia v0.19.29.' }
if (-not $appJs01929.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.29.' }
if (-not $index01929.Contains('/app.css?v=0.19.30') -or -not $index01929.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.29 ausente.' }
...
Write-Host "[1968/1970] Validando ausencia de alteracao de schema v0.19.30..." -ForegroundColor Cyan
if (Get-ChildItem .\src\HealthPlatform.Infrastructure\Migrations -File | Where-Object { $_.Name -match '01930' }) { throw 'v0.19.30 nao deveria criar migration.' }
Write-Host "    Sem migration nova: OK." -ForegroundColor Green

Write-Host "[1969/1970] Validando versao publica v0.19.30..." -ForegroundColor Cyan
if ($version01930 -ne '0.19.30') { throw 'VERSION.txt inesperado na v0.19.30.' }
if (($health01930 | Select-String -Pattern 'version = "0.19.30"' -AllMatches).Matches.Count -lt 2) { throw 'Health nao anuncia v0.19.30.' }
if (-not $program01930.Contains('Version = "v0.19.30"')) { throw 'Swagger nao anuncia v0.19.30.' }
if (-not $appJs01930.Contains("const HP_MVP_VERSION='0.19.30';")) { throw 'Interface nao anuncia v0.19.30.' }
if (-not $index01930.Contains('/app.css?v=0.19.30') -or -not $index01930.Contains('/app.js?v=0.19.30')) { throw 'Cache busting v0.19.30 ausente.' }
Write-Host "    API/UI/VERSION: 0.19.30 OK." -ForegroundColor Green

Write-Host "[1970/1970] Validando versao funcional v0.19.30..." -ForegroundColor Cyan
Write-Host "    v0.19.30 / Patient Home Cleanup: OK." -ForegroundColor Green
Write-Host "TESTE DE FUMACA CONCLUIDO." -ForegroundColor Green
Write-Host "Nenhum registro foi criado ou alterado." -ForegroundColor Green
