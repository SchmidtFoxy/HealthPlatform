...
if ($health.version -ne "0.7.6") { throw "Versao inesperada da API: $($health.version)" }
...
if ($version.Trim() -ne "0.7.6") { throw "VERSION.txt inesperado." }
...
$indexSource = Get-Content .\src\HealthPlatform.Api\wwwroot\index.html -Encoding UTF8 -Raw
if (-not $indexSource.Contains("MVP Preview • v0.7.6") -or
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.6.1 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.6.2 inconsistente." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao atual inconsistente ao validar v0.6.3." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Compatibilidade v0.6.4 inconsistente na versao atual." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.6.6 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.7.6"')) { throw "Health endpoint nao anuncia v0.6.6." }
...
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.1 inconsistente." }
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if (-not $healthSource.Contains('version = "0.7.6"')) { throw "Health endpoint nao anuncia v0.7.1." }
...
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.1 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.1." }
...
Write-Host "[694/720] Validando ausencia de alteracao indevida de schema v0.7.6..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "PREPARAR 37/37 foi alterado sem necessidade." }
if (Test-Path .\scripts\sql\v0.7.6_seed_resiliente.sql) { throw "v0.7.6 nao deveria exigir migration." }
Write-Host "    Robustez de seed nao altera schema: OK."

Write-Host "[695/720] Validando versao corrente v0.7.6..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.6." }
Write-Host "    API/UI/VERSION: 0.7.6 OK."
...
if (-not $anaSeedSource.Contains('Seed esportivo PESADO da Ana Ribeiro (v7)') -or -not $anaSeedSource.Contains('HealthPlatform v0.7.6')) { throw "Banner do seed Ana v7/v0.7.6 ausente." }
...
Write-Host "[702/720] Validando ausencia de alteracao indevida de schema v0.7.6..."
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "PREPARAR 37/37 foi alterado sem necessidade." }
if (Test-Path .\scripts\sql\v0.7.6_seed_numerico.sql) { throw "v0.7.6 nao deveria exigir migration." }
Write-Host "    Correcao de seed nao altera schema: OK."

Write-Host "[703/720] Validando versao corrente v0.7.6..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.6 inconsistente." }
...
Write-Host "[710/720] Validando ausencia de migration v0.7.6..."
if (Test-Path .\scripts\sql\v0.7.6_seed_validacao.sql) { throw "v0.7.6 nao deveria exigir migration." }
Write-Host "    Schema permanece 37/37: OK."

Write-Host "[711/720] Validando versao corrente v0.7.6..."
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.6." }
Write-Host "    API/UI/VERSION: 0.7.6 OK."
...
Write-Host "[718/720] Validando ausencia de migration v0.7.6..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "Setup 37/37 foi alterado sem necessidade." }
if (Test-Path .\scripts\sql\v0.7.6_seed_automatic_vars.sql) { throw "v0.7.6 nao deveria exigir migration." }
Write-Host "    Schema permanece 37/37: OK."

Write-Host "[719/720] Validando versao corrente v0.7.6..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
$appJsSource = Get-Content .\src\HealthPlatform.Api\wwwroot\app.js -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.6 inconsistente." }
...
Write-Host "[726/728] Validando ausencia de migration v0.7.6..."
$setupSource = Get-Content .\scripts\setup.ps1 -Encoding UTF8 -Raw
if (-not $setupSource.Contains('[37/37] Aplicando upgrade v0.6.4')) { throw "Schema 37/37 foi alterado sem necessidade." }
if (Test-Path .\scripts\sql\v0.7.6_dor_corporal.sql) { throw "v0.7.6 nao deveria exigir migration." }
Write-Host "    Registro reutiliza Diario; schema permanece 37/37: OK."

Write-Host "[727/728] Validando versao corrente v0.7.6..."
$version = Get-Content .\VERSION.txt -Encoding UTF8 -Raw
$healthSource = Get-Content .\src\HealthPlatform.Api\Controllers\HealthController.cs -Encoding UTF8 -Raw
if ($version.Trim() -ne "0.7.6" -or -not $appJsSource.Contains("const HP_MVP_VERSION='0.7.6';")) { throw "Versao v0.7.6 inconsistente." }
if (($healthSource | Select-String -Pattern 'version = "0.7.6"' -AllMatches).Matches.Count -lt 2) { throw "Health endpoint/fallback nao anunciam v0.7.6." }
...
Write-Host "[728/728] Validando versao funcional v0.7.6..."
Write-Host "    v0.7.6 / Dor por Regiao Corporal + impacto no treino: OK."
