const HP_SW_CACHE = 'aesyn-static-v0.19.43';
const HP_SW_ASSETS = ['/', '/manifest.webmanifest', '/app.css?v=0.19.43', '/app.js?v=0.19.43', '/icons/icon-192.png', '/icons/icon-512.png', '/icons/apple-touch-icon.png'];
