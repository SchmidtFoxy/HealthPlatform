const HP_SW_CACHE = 'aesyn-static-v0.19.44';
const HP_SW_ASSETS = ['/', '/manifest.webmanifest', '/app.css?v=0.19.44', '/app.js?v=0.19.44', '/icons/icon-192.png', '/icons/icon-512.png', '/icons/apple-touch-icon.png'];
