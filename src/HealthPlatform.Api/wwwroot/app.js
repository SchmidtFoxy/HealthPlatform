...
async function loadMyPatientPortal(){
  ...
  const [d,solicitacoes,protocolo]=await Promise.all([
    ...
    api('/api/portal/me/protocolo-acompanhamento')
  ]);
