...
async function loadMyPatientPortal(){
  ...
  const e=d.evolucaoCorporal||{},plano=d.planoAlimentarAtual,prox=d.proximaConsulta,readiness=d.prontidaoDiaria;
