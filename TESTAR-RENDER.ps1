...
Write-Host " HealthPlatform v0.4.4 - TESTE REMOTO RENDER" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
if ($health.status -ne "ok" -or $health.version -ne "0.4.4" -or $health.database -ne "connected") {
...
if ($health2.version -ne "0.4.4") { throw "Versao remota mudou durante o teste." }
