...
Write-Host " HealthPlatform v0.4.6 - TESTE REMOTO RENDER" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
if ($health.status -ne "ok" -or $health.version -ne "0.4.6" -or $health.database -ne "connected") {
...
if ($health2.version -ne "0.4.6") { throw "Versao remota mudou durante o teste." }
